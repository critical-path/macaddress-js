...
class ExtendedIdentifier48 {
    ...
    get isValid() {
        ...
        return plain.test(this.original)
            || hyphen.test(this.original)
            || colon.test(this.original)
            || dot.test(this.original)
    }
     ...
     */
    get firstOctet() {
        return this.octets.shift()
    }

    /**
     * The decimal equivalent of the hexadecimal identifier passed
     * in by the user.
     *
     * For example, if the user passes in `A0-B1-C2-D3-E4-F5`,
