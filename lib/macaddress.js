...
class MediaAccessControlAddress extends ExtendedIdentifier48 {
     ...
     */ 
    get isBroadcast() {
        return this.normalized === "ffffffffffff"
    }
     ...
     */
    get isMulticast() {
        return this.firstOctet.binary.slice(7) === "1"
    }
     ...
     */ 
    get isUAA() {
        return this.isUnicast && this.firstOctet.binary.slice(6, 7) === "0"
    }
     ...
     */
    get isLAA() {
        return this.isUnicast && this.firstOctet.binary.slice(6, 7) === "1"
    }
}
